...
Процедура MakePackage()
	...
	ДобавитьЭлемент("Windows" , "i386"   , "bin32/Release/libGitFor1cWin32.dll");
	ДобавитьЭлемент("Windows" , "x86_64" , "bin64/Release/libGitFor1cWin64.dll");
