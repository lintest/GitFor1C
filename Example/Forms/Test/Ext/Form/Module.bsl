...
&НаКлиенте
Процедура ДобавитьФайл(ТекстовыйДокумент, ИмяФайла)
...
Процедура Test(AddInId) Экспорт
	...
	ИмяФайла = ВременнаяПапка + "tools/Compile.os";
	ТекстовыйДокумент = ПрочитатьФайл(ИмяФайла);
	ТекстовыйДокумент.УдалитьСтроку(7);
	ТекстовыйДокумент.УдалитьСтроку(7);
	ТекстовыйДокумент.УдалитьСтроку(7);
	ТекстовыйДокумент.УдалитьСтроку(7);
	ДобавитьФайл(ТекстовыйДокумент, ИмяФайла);
